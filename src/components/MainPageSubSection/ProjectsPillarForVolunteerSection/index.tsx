...
export default function ProjectsPillarForVolunteerSection() {
    ...
    return (
        <section
            ref={containerRef}
            onClick={handleBackgroundClick}
            className="min-h-screen w-full bg-cover bg-center px-6 py-20 absolute z-30"
            style={{
                backgroundImage: "url('/space-bg.png')",
                backgroundSize: "cover",
                backgroundPosition: "center",
        ...
        >
            {/* <div className="bg-black backdrop-blur rounded-lg">
                <h1
                    ref={headerRef}
                    className="text-3xl md:text-4xl font-bold text-center text-white mb-16"
                >
            ...
            <div
                ref={detailRef}
                className="max-w-2xl mx-auto mt-20 text-center text-white opacity-0"
            >
                {activeProject && (
                    <>
                        <h2 className="text-2xl md:text-3xl font-bold mb-4">
